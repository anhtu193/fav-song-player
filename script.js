...
const songs = [
	...
	{ path: "assets/songs/BuonHayVui.mp3" },
	{ path: "assets/songs/SojuLove.mp3" },
	{ path: "assets/songs/YourSmile.mp3" },
	{ path: "assets/songs/1000AnhMat.mp3" },
	{ path: "assets/songs/TakeOffYourHand.mp3" },
	{ path: "assets/songs/DefJamExclusiveCypher.mp3" },
	{ path: "assets/songs/NoBoundary.mp3" },
	{ path: "assets/songs/RapChoAnhEm.mp3" },
	{ path: "assets/songs/TienLaChi.mp3" },
	{ path: "assets/songs/PhongLong.mp3" },
	{ path: "assets/songs/DamRucRo.mp3" },
	...
	{ path: "assets/songs/StuKing.mp3" },
	{ path: "assets/songs/MuaHong.mp3" },
	{ path: "assets/songs/Shawty.mp3" },
	{ path: "assets/songs/BUSINESSMODE.mp3" },
	{ path: "assets/songs/SimpleLove.mp3" },
];
